...
// Falls back to console.log when env vars are not set (dev / staging).
//
// REQUIRED in Meta Business Manager:
//   1. Create a message template named WHATSAPP_OTP_TEMPLATE (default: cheap_travels_otp)
//   2. Category: AUTHENTICATION or UTILITY
//   3. Body: "Your Cheap Travels India OTP is {{1}}. Valid for 5 minutes. Do not share."
//   4. Get it approved before going live.
